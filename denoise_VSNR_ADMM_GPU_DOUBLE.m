...
function u=denoise_VSNR_ADMM_GPU_DOUBLE(u0,psi,nit,beta)

d1=gpuArray(zeros(size(u0)));
d2=gpuArray(zeros(size(u0)));
...
y1=gpuArray(zeros(size(u0)));
y2=gpuArray(zeros(size(u0)));
lambda1=gpuArray(zeros(size(u0)));
lambda2=gpuArray(zeros(size(u0)));
