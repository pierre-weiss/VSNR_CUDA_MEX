...
data =  {
    'Matlab 1 core', '1 hour',sprintf('%1.1f',time(1)),sprintf('%1.1f',1.0),'~500$';
    'Matlab 20 cores', '1 hour',sprintf('%1.1f',time(2)), sprintf('%1.1f',time(1)/time(2)), '~10 000$';
    ...
    'Matlab GPU DOUBLE', '1 hour',sprintf('%1.1f',time(6)), sprintf('%1.1f',time(1)/time(5)), '~2000$';
    'Matlab GPU SINGLE', '1 hour',sprintf('%1.1f',time(5)), sprintf('%1.1f',time(1)/time(6)), '~2000$';
